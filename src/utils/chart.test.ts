...
describe("getYAxisMax", () => {
    it("returns 1 * orderOfMagnitude when normalized <= 1", () => {
        ...
        expect(getYAxisMax(results)).toBe(100000);
    });
    ...
    it("returns 2 * orderOfMagnitude when 1 < normalized <= 2", () => {
        ...
        expect(getYAxisMax(results)).toBe(200000);
    });
    ...
    it("returns 5 * orderOfMagnitude when 2 < normalized <= 5", () => {
        ...
        expect(getYAxisMax(results)).toBe(500000);
    });
    ...
    it("returns 10 * orderOfMagnitude when normalized > 5", () => {
        ...
        expect(getYAxisMax(results)).toBe(1000000);
    });
    ...
    describe("edge cases", () => {
        it("handles single path", () => {
            ...
            expect(getYAxisMax(results)).toBe(2000000);
        });
        ...
        it("handles very small values", () => {
            ...
            expect(getYAxisMax(results)).toBe(1);
        });
        ...
        it("handles very large values", () => {
            ...
            expect(getYAxisMax(results)).toBe(20000000);
        });
        ...
        it("handles zero percentile90 values", () => {
            ...
            expect(getYAxisMax(results)).toBe(0);
        });
    });
});
